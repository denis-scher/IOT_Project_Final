...
//    private Pair<ArrayList<String[]>, String> CsvRead(Uri uri) {
...
//                }
//            }
//            // Extract the number of steps from the last row and remove it from the list
//            steps = CsvData.get(CsvData.size() - 1)[1];
//            CsvData.remove(CsvData.size() - 1);
//        } catch (Exception e) {
//            e.printStackTrace();
//        }
//        return new Pair<>(CsvData, steps);
//    }
